...
@Component({
  selector: 'app-intake-home3',
  templateUrl: './intake-home3.component.html',
  styleUrls: ['./intake-home3.component.css']
})
export class IntakeHome3Component implements OnInit, AfterViewInit {
