...
@Component({
  selector: 'app-users-parts-market3',
  templateUrl: './users-parts-market3.component.html',
  styleUrls: ['./users-parts-market3.component.css']
})
export class UsersPartsMarket3Component implements OnInit, AfterViewInit {
  ...
  getUserLastNameOverview(): void {

    this.userService.getUserLastNameOverview().subscribe({
      next: result => {
        console.log(result);
