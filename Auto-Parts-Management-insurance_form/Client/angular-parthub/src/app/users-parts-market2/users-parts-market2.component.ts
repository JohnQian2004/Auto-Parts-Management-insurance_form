...
@Component({
  selector: 'app-users-parts-market2',
  templateUrl: './users-parts-market2.component.html',
  styleUrls: ['./users-parts-market2.component.css']
})
export class UsersPartsMarket2Component implements OnInit, AfterViewInit {
