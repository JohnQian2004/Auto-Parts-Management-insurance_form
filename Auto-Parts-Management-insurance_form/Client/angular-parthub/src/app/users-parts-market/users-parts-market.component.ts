...
@Component({
  selector: 'app-users-parts-market',
  templateUrl: './users-parts-market.component.html',
  styleUrls: ['./users-parts-market.component.css']
})
export class UsersPartsMarketComponent implements OnInit, AfterViewInit {
