...
@Entity
@Table(name = "purchaseordervehicles")
public class PurchaseOrderVehicle extends AuditModel {
    ...
    public void setReturnedAt(Date returneddAt) {
        this.returnedAt = returneddAt;
    }
    ...
    public PurchaseOrderVehicle(String title, String description, boolean published) {
        this.title = title;
