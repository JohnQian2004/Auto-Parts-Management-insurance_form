package com.xoftex.parthub.security.jwt;
...
public class JwtUtils {
  ...
  @Value("${xoftex.app.jwtSecret}")
  private String jwtSecret;

  @Value("${xoftex.app.jwtExpirationMs}")
  private int jwtExpirationMs;

  @Value("${xoftex.app.jwtCookieName}")
  ...
  public ResponseCookie generateJwtCookieEmail(UserDetailsImpl userPrincipal) {
  ...
  public ResponseCookie generateJwtCookieEmail(String email) {
