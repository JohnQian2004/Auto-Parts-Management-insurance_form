...
@Entity
@Table(name = "requestparts")
public class RequestPart extends AuditModel {
    ...
    public RequestPart(String title, String description) {
        this.title = title;
    ...
    public String toString() {
        return "requestpart [id=" + id + ", title=" + title + ", desc=" + description + "]";
    }
